...
// handles the LiveBusStream RPC (bi-directional streaming)
const transportService = {
  LiveBusStream: (call) => {
    ...
    call.on('data', (busUpdate) => {
      ...
      // log to terminal for GUI testing/demo
      console.log(`Responding to GUI with: Update received for bus ${busUpdate.bus_id}`);
...
server.addService(transportProto.TransportService.service, transportService); // binds the service logic to proto
